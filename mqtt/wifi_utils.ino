...
void wifi_connect_multi(String hostname){
  ...
  wm.addAP("SFR_BA28", "9kun36xntt4btx84kbwe");
  wm.addAP("iPhone de Khalil", "WIFIKHALIL123");
  wm.addAP("PlanetCampus - Prive 004436", "Nhs5M9RchcFaZ");
  wm.addAP("P20 Pro", "quentin06");
